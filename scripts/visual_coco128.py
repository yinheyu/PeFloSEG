...
img_base_path = r'D:\zidong-labelme\yolov5-seg\dataset\custom_dataset\images\train'
lab_base_path = r'D:\zidong-labelme\yolov5-seg\dataset\custom_dataset\labels\train'
